  ...
  return (
    <div className={`relative h-screen w-full overflow-hidden ${className}`}>
      ...
      <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-2 select-none pointer-events-none">
        <h1
          className={`m-0 p-0 text-white font-bold leading-none drop-shadow-[0_0_20px_rgba(0,0,0,0.5)] ${titleSize} text-center`}
        >
          {title}
        </h1>
        <h2
          className={`m-0 p-0 text-white font-medium leading-none drop-shadow-[0_0_20px_rgba(0,0,0,0.5)] ${subtitleSize} text-center`}
        >
          {subtitle}
        </h2>
        <p
          className={`m-0 p-0 text-white leading-none drop-shadow-[0_0_20px_rgba(0,0,0,0.5)] ${captionSize} text-center opacity-80`}
        >
          {caption}
        </p>
      </div>
